...
- **License:** MIT; the unmodified upstream notice is included in `src/main/resources/THIRD_PARTY/Mhzy/LICENSE.txt`. Its copyright placeholders are preserved as supplied by upstream.
