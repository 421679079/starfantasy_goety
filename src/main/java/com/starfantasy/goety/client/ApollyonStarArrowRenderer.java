 ...
 */
public final class ApollyonStarArrowRenderer extends EntityRenderer<ApollyonStarArrowEntity> {
    public ApollyonStarArrowRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void m_7392_(
            ApollyonStarArrowEntity arrow,
            float yaw,
            float partialTick,
            PoseStack poseStack,
    ...
    private static void renderLingeringTrail(
        ...
        float remaining = Mth.m_14036_(
                (ApollyonStarArrowEntity.EXPLOSION_TRAIL_TICKS
    ...
    @Override
    public ResourceLocation m_5478_(ApollyonStarArrowEntity entity) {
