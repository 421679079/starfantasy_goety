...
/** Goety's complete 450-tick summoning-circle motion compressed to its configured duration. */
public final class ApollyonPageantSummonRenderer
        extends EntityRenderer<ApollyonPageantSummonEntity> {
    ...
    public ApollyonPageantSummonRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void m_7392_(ApollyonPageantSummonEntity entity, float yaw, float partialTick,
                        PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        float age = entity.compressedVisualAge(partialTick);
    ...
    @Override
    public ResourceLocation m_5478_(ApollyonPageantSummonEntity entity) {
        return TEXTURE;
    }
}
