...
public final class ApollyonPageantBeamRenderer
        extends EntityRenderer<ApollyonPageantBeamEntity> {
    ...
    @Override
    public void m_7392_(ApollyonPageantBeamEntity entity, float yaw, float partialTick,
    ...
    @Override
    public ResourceLocation m_5478_(ApollyonPageantBeamEntity entity) {
        return BEAM_MAIN;
    }
    ...
    private static void drawLayer(VertexConsumer consumer, Matrix4f matrix, float yaw,
        ...
        float endX = forwardX * ApollyonPageantBeamEntity.LENGTH;
        float endZ = forwardZ * ApollyonPageantBeamEntity.LENGTH;
        float endV = scroll + ApollyonPageantBeamEntity.LENGTH * 0.28F;
