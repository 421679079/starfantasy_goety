...
public final class ApostleArrowTrail {
    ...
    private ApostleArrowTrail() {}
    public static void render(DeathArrow arrow, float partialTick, PoseStack poseStack, MultiBufferSource buffer) {
        if (!(arrow instanceof StarFantasyStarArrowVisual visual)) return;
        ...
        int trailCount = visual.starFantasyStarArrowTrailCount();
