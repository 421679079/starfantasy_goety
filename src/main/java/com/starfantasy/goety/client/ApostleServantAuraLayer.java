...
public final class ApostleServantAuraLayer extends GeoRenderLayer<ApostleServantEntity> {
    private static final ResourceLocation AURA=new ResourceLocation("goety","textures/entity/cultist/apostle_aura.png");
    public ApostleServantAuraLayer(GeoRenderer<ApostleServantEntity> renderer) { super(renderer); }
    @Override public void render(PoseStack pose,ApostleServantEntity entity,BakedGeoModel model,RenderType base,
